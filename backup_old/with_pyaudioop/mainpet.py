...
#         self.exchange_display = ExchangeRateDisplay(self, self.exchange_config)
#
#         # 连接信号
...
#
#         # ⭐ 新增：更新报时组件位置
#         if hasattr(self, 'time_display') and self.time_display.is_visible:
#             self.time_display.update_position()
#
#     # ============ 右键菜单 ============
#
...
#
#         # ⭐ 汇率监控
#         exchange_action = QAction("💱 汇率监控", self)
#         exchange_action.triggered.connect(self.toggle_exchange_widget)
#         menu.addAction(exchange_action)
#
#         # ⭐ 报时显示
#         time_action = QAction("🕐 报时显示", self)
